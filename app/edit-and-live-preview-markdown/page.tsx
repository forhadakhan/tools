...
export const metadata: Metadata = {
    ...
    keywords: 'Markdown editor, live Markdown preview, online Markdown tool, create Markdown files, edit Markdown documents, PDF export, Next.js Markdown editor, Markdown playground, web-based Markdown editor',
};
